      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-10 lg:items-center">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="font-montreal mb-2 text-2xl font-bold text-slate-900 md:text-3xl">
                Why Choose{' '}
                <span className="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
                  Sabaysis
                </span>
              </h3>
              <p className="font-gotham text-base leading-relaxed text-slate-600 md:text-lg">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {features.map((feature, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="group relative overflow-hidden rounded-2xl backdrop-blur-sm border border-slate-200 p-6 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl hover:border-emerald-300"
                  >
                    ...
                    <div className="relative z-10">
                      <div className={`mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${feature.gradient} shadow-lg transition-transform duration-300 group-hover:scale-110`}>
                        <Icon className="h-6 w-6 text-white" />
                      </div>
                      <p className="font-montreal text-sm font-bold text-slate-900">{feature.text}</p>
                    </div>
                  </div>
                );
              })}
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-4 rounded-2xl p-6 backdrop-blur-sm border border-emerald-200/50 pb-10">
              <div className="text-center">
                <p className="font-montreal text-3xl font-bold text-emerald-600">200+</p>
                <p className="font-gotham text-xs text-slate-600 mt-1">Projects</p>
              </div>
              <div className="text-center">
                <p className="font-montreal text-3xl font-bold text-teal-600">98%</p>
                <p className="font-gotham text-xs text-slate-600 mt-1">Satisfaction</p>
              </div>
              <div className="text-center">
                <p className="font-montreal text-3xl font-bold text-cyan-600">10+</p>
                <p className="font-gotham text-xs text-slate-600 mt-1">Years</p>
              </div>
            </div>
          </div>
        </div>
